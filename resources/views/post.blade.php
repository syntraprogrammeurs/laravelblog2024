...
<head>
    ...
    <!-- Favicon  -->
    <link rel="icon" href="{{asset('assets/img/imgfront/core-img/favicon.ico')}}">
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                ...
                <div class="col-12 col-md-4">
                    <div class="logo-area">
                        <a href="index.html"><img src="{{asset('assets/img/imgfront/core-img/logo.png')}}" alt="logo"></a>
                    </div>
                </div>
                <!-- Header Advert Area -->
                <div class="col-12 col-md-8">
                    <div class="header-advert-area">
                        <a href="#"><img src="{{asset('assets/img/imgfront/bg-img/top-advert.png')}}" alt="header-add"></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12">
                    <div class="single-post-thumb">
                        <img src="{{asset('assets/img/imgfront/blog-img/24.jpg')}}" alt="">
                    </div>
                </div>
                <div class="col-12 col-md-8">
                    <div class="single-post-text">
                        ...
                        <li class="single_comment_area">
                            <div class="comment-wrapper d-md-flex align-items-start">
                                ...
                                <div class="comment-author">
                                    <img src="{{asset('assets/img/imgfront/blog-img/25.jpg')}}" alt="">
                                </div>
                                <!-- Comment Content -->
