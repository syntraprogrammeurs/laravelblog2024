...
@section('content')
    ...
    <section class="welcome-blog-post-slide owl-carousel">
        ...
        @foreach($postTickers as $postTicker)
            <div class="single-blog-post-slide bg-img background-overlay-5" style="background-image: url(  @if($postTicker->photo && !Str::startsWith($postTicker->photo->file, 'http'))
                    ...
                    <div class="gazette-todays-post section_padding_100_50">
                        ...
                        <div class="gazette-single-todays-post d-md-flex align-items-start mb-50">
                            <div class="todays-post-thumb">
                                <img src="{{asset('assets/img/imgfront/blog-img/2.jpg')}}" alt="">
                            </div>
                        ...
                        <div class="gazette-single-todays-post d-md-flex align-items-start mb-50">
                            <div class="todays-post-thumb">
                                <img src="{{asset('assets/img/imgfront/blog-img/3.jpg')}}" alt="">
                            </div>
                            <div class="todays-post-content">
                                <!-- Post Tag -->
                                <div class="gazette-post-tag">
                    ...
                    <div class="sidebar-area">
                        ...
                        <div class="breaking-news-widget">
                            ...
                            <div class="single-breaking-news-widget">
                                <img src="{{asset('assets/img/imgfront/blog-img/bn-1.jpg')}}" alt="">
                            ...
                            <!-- Single Breaking News Widget -->
                            <div class="single-breaking-news-widget">
                                <img src="{{asset('assets/img/imgfront/blog-img/bn-2.jpg')}}" alt="">
                                <div class="breakingnews-title">
                                    <p>breaking news</p>
                                </div>
                                <div class="breaking-news-heading gradient-background-overlay">
                        ...
                        <div class="donnot-miss-widget">
                            ...
                            <div class="single-dont-miss-post d-flex mb-30">
                                <div class="dont-miss-post-thumb">
                                    <img src="{{asset('assets/img/imgfront/blog-img/dm-1.jpg')}}" alt="">
                                </div>
                            ...
                            <div class="single-dont-miss-post d-flex mb-30">
                                <div class="dont-miss-post-thumb">
                                    <img src="{{asset('assets/img/imgfront/blog-img/dm-2.jpg')}}" alt="">
                                </div>
                                <div class="dont-miss-post-content">
                            ...
                            <div class="single-dont-miss-post d-flex mb-30">
                                <div class="dont-miss-post-thumb">
                                    <img src="{{asset('assets/img/imgfront/blog-img/dm-3.jpg')}}" alt="">
                                </div>
                                <div class="dont-miss-post-content">
                        ...
                        <div class="advert-widget">
                            ...
                            <div class="advert-thumb mb-30">
                                <a href="#"><img src="{{asset('assets/img/imgfront/bg-img/add.png')}}" alt=""></a>
                            </div>
                        </div>
                        <!-- Subscribe Widget -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-4">
                        ...
                        <div class="gazette-single-catagory-post">
                            <div class="single-catagory-post-thumb mb-15">
                                <img src="{{asset('assets/img/imgfront/blog-img/12.jpg')}}" alt="">
                            </div>
                            <!-- Post Tag -->
                            <div class="gazette-post-tag">
                                <a href="#">Video</a>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="row">
                            <div class="col-12 col-md-6">
                                ...
                                <div class="gazette-single-catagory-post">
                                    <div class="single-catagory-post-thumb mb-15">
                                        <img src="{{asset('assets/img/imgfront/blog-img/14.jpg')}}" alt="">
                                    </div>
                                    <!-- Post Tag -->
                                    <div class="gazette-post-tag">
                                        <a href="#">Others</a>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="gazette-single-catagory-post">
                                    <div class="single-catagory-post-thumb mb-15">
                                        <img src="{{asset('assets/img/imgfront/blog-img/15.jpg')}}" alt="">
                                    </div>
                                    <!-- Post Tag -->
                                    <div class="gazette-post-tag">
                                        <a href="#">Video</a>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="gazette-single-catagory-post">
                                    <div class="single-catagory-post-thumb mb-15">
                                        <img src="{{asset('assets/img/imgfront/blog-img/16.jpg')}}" alt="">
                                    </div>
                                    <!-- Post Tag -->
                                    <div class="gazette-post-tag">
                                        <a href="#">Interview</a>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="gazette-single-catagory-post">
                                    <div class="single-catagory-post-thumb mb-15">
                                        <img src="{{asset('assets/img/imgfront/blog-img/17.jpg')}}" alt="">
                                    </div>
                                    <!-- Post Tag -->
                                    <div class="gazette-post-tag">
                                        <a href="#">Video</a>
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <div class="gazette-single-catagory-post">
                            <div class="single-catagory-post-thumb mb-15">
                                <img src="{{asset('assets/img/imgfront/blog-img/13.jpg')}}" alt="">
                            </div>
                            <!-- Post Tag -->
                            <div class="gazette-post-tag">
                                <a href="#">Video</a>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-5">
                                    <div class="editorial-post-thumb">
                                        <img src="{{asset('assets/img/imgfront/blog-img/bitcoin.jpg')}}" alt="">
                                    </div>
                                </div>
